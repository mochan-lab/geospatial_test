...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public class GeospatialController : MonoBehaviour
    {
        ...
        public GameObject Gojunoto;
        public GameObject ItoPerth;
        private GameObject MyObjectPrefab = null;

        ///<summary>
        /// change my object position buttons +, -
        /// </summary>
        public Button LatPlusButton;
        public Button LatMinusButton;
        public Text MyObjectLatitude;
        public Button LongPlusButton;
        public Button LongMinusButton;
        public Text MyObjectLongitude;
        public Button AltPlusButton;
        public Button AltMinusButton;
        public Text MyObjectAltitude;
        public Button AngPlusButton;
        public Button AngMinusButton;
        public Text MyObjectAngle;
        ...
        /// <summary>
        /// my object anchor : WGS84 : right click on google map
        /// </summary>
        /// 
        //[SerializeField] private double _myLatitude;
        //[SerializeField] private double _myLongitude;
        //[SerializeField] private double _myAltitude;
        //[SerializeField] private float _myAngle;    //heding degree from north, +clockwise, -180 to +180

        public double _myLatitude;
        public double _myLongitude;
        public double _myAltitude;
        public float _myAngle;

        private bool _shouldPlaceMyObject = true;
        private GameObject _nowMyObject = null;

        //public void LoadVariStarting(double lat, double lon, double alt, float ang)
        //{
        //    _myLatitude = lat;
        //    _myLongitude = lon;
        //    _myAltitude = alt;
        ...
        /// <summary>
        /// change my object position
        /// </summary>
        private double _changeLatLon = 0.00001;
        private double _changeAlt = 0.1;
        private float _changeAng = 5f;

        public void OnLatitudePlus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
                _myLatitude += _changeLatLon;
                _shouldPlaceMyObject = true;
            }
        }
        public void OnLatitudeMinus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
        ...
        public void OnLongitudePlus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
                _myLongitude += _changeLatLon;
                _shouldPlaceMyObject = true;
            }
        }
        public void OnLongitudeMinus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
        ...
        public void OnAltitudePlus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
                _myAltitude += _changeAlt;
                _shouldPlaceMyObject = true;
            }
        }
        public void OnAltitudeMinus()
        {
            if (_nowMyObject!=null)
            {
                Destroy(_nowMyObject);
        ...
        public void Start()
        {
            ...
            {
                case 0:
                    MyObjectPrefab = Gojunoto;
                    break;
                case 1:
                    MyObjectPrefab = ItoPerth;
                    break;
            }
        }
        ...
        public void Update()
        {
            ...
            if (earthTrackingState == TrackingState.Tracking)
            {
                ...
                PlaceMyObject();
                _nowMyObject.SetActive(true);   //Why I need SetActive(true)???
            }
            else
            {
        ...
        private bool PlaceMyObject()
        {
            if (!_shouldPlaceMyObject)
            {
                return false;
            }

            Quaternion quaternion =
                Quaternion.AngleAxis(180f - _myAngle, Vector3.up);
            var anchor = AnchorManager.AddAnchor(
                _myLatitude, _myLongitude, _myAltitude, quaternion);
            if (anchor != null)
            {
                GameObject instantObject = Instantiate(MyObjectPrefab, anchor.transform);
                _nowMyObject = instantObject;
                _shouldPlaceMyObject = false;
                MyObjectLongitude.text = _myLongitude.ToString("F6");
                MyObjectLatitude.text = _myLatitude.ToString("F6");
                MyObjectAltitude.text = _myAltitude.ToString("F2");
                MyObjectAngle.text = _myAngle.ToString("F1");
                return true;
            }
            return false;
        }
        ...
        private void ReturnWithReason(string reason)
        {
            ...
            _isReturning = true;
            Invoke(nameof(QuitApplication), _errorDisplaySeconds);    //Quit application (_errorDisplaySeconds) seconds after error happen  
        }
